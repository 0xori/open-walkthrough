(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("openWalkthrough", [], factory);
	else if(typeof exports === 'object')
		exports["openWalkthrough"] = factory();
	else
		root["openWalkthrough"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var walkThoughExecutor = {
	    ...
	    enableAutoScroll: function enableAutoScroll() {
	     ...
	     */
	    setScrollOffsetElements: function setScrollOffsetElements(elements) {
	        walkThoughExecutor._scrollOffsetElements = elements;
	    },
	
	    addScrollOffsetElement: function addScrollOffsetElement(key, selector) {
	    ...
	    removeScrollOffsetElement: function removeScrollOffsetElement(key) {
	        if (walkThoughExecutor._scrollOffsetElements[key]) {
	    ...
	    resetScrollOffsetElements: function resetScrollOffsetElements() {
	        walkThoughExecutor._scrollOffsetElements = {};
	    },
	
	    setFloatingButtonText: function setFloatingButtonText(text) {
	     ...
	     * @param template (html)
	     */
	    setFloatingButtonTemplate: function setFloatingButtonTemplate(template) {
	        walkThoughExecutor._floatingButtonTemplate = template;
	    },
	
	    disableFloatingButton: function disableFloatingButton() {
	        walkThoughExecutor._showFloatingButton = false;
	    },
	
	    enableFloatingButton: function enableFloatingButton() {
	    ...
	    resetAction: function resetAction(action) {
	        switch (action.type) {
	            case actionTypes.ACTION_POPOVER:
	    ...
	    resetWalkthrough: function resetWalkthrough() {
	        walkThoughExecutor.resetActions();
	        walkThoughExecutor.resetIndex();
	    ...
	    renderPopover: function renderPopover(action) {
	        var options = {
	    ...
	    showPopover: function showPopover(selector, options) {
	    ...
	    hidePopover: function hidePopover(selector) {
	        $(selector).popover("hide");
	    },
	
	    destroyPopover: function destroyPopover(selector) {
	        $(selector).popover("destroy");
	    },
	
	    showFloatingButton: function showFloatingButton() {
	    ...
	    suspendWalkthrough: function suspendWalkthrough() {
	        walkThoughExecutor.hideBackgroundLayer();
	        if (currAction + 1 <= actionsStack.length) {
	    ...
	    resumeWalkthrough: function resumeWalkthrough() {
	        if (currAction + 1 <= actionsStack.length) {
	            var currentAction = actionsStack[currAction];
	    ...
	    renderFloatingButton: function renderFloatingButton() {
	    ...
	    renderBackgroundLayer: function renderBackgroundLayer() {
	    ...
	    showBackgroundLayer: function showBackgroundLayer() {
	        $("#" + walkThoughExecutor._backgroundLayerSelector).show();
	    },
	
	    hideBackgroundLayer: function hideBackgroundLayer() {
	        $("#" + walkThoughExecutor._backgroundLayerSelector).hide();
	    },
	
	    registerOnWalkThroughFinish: function registerOnWalkThroughFinish(callback) {
	        finishStackCallbacks.push(callback);
	    },
	
	    registerBeforeWalkThrough: function registerBeforeWalkThrough(callback) {
	        beforeWalkthroughStackCallback.push(callback);
	    },
	
	    registerBeforeNext: function registerBeforeNext(callback) {
	        beforeNextStackCallback.push(callback);
	    },
	
	    registerAfterNext: function registerAfterNext(callback) {
	        afterNextStackCallback.push(callback);
	    },
	
	    onWalkThroughFinish: function onWalkThroughFinish() {
	    ...
	    onBeforeWalkthrough: function onBeforeWalkthrough() {
	    ...
	    onAfterNext: function onAfterNext() {
	...
	exports.default = walkThoughExecutor;
